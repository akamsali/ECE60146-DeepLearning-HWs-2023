    ...
    #                                               deriv_sigmoid_avg[i] for i in range(len(vars_in_layer))])
                ...
                for j,var in enumerate(vars_in_layer):
                    ...
                    for i,param in enumerate(layer_params):
                        ...
                        # @akamsali: updatethe learnable parameters
                        step = self.learning_rate * m_hat / np.sqrt(v_hat + self.epsilon)
                        self.vals_for_learnable_params[param] += step
                        # s@akamsali: tore the current values of first and second moment parameters 
                ...
                #  @akamsali: store the current values of first and second moment parameters 
                # for next iteration of training
